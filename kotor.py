...
display_text = Entry(main, font=("arial", 20, "bold"), textvariable=input_value, bd=30, insertborderwidth=4, bg="Grey", justify=RIGHT)
...
Button(main, **button_properties, text="Del", command=buttonDelete).grid(row=1, column=2, sticky="nsew")
